    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <form onSubmit={handleSignup} className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <p className="text-slate-500 mt-2">Start tracking your habits today</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500">
          ...
          <button type="button" onClick={() => router.push('/login')} className="text-indigo-600 font-medium hover:underline">
            Log in
          </button>
        </p>
      </form>
